...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { descrition: @testimonial.descrition, designation: @testimonial.designation, image: @testimonial.image, name: @testimonial.name }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { descrition: @testimonial.descrition, designation: @testimonial.designation, image: @testimonial.image, name: @testimonial.name }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
